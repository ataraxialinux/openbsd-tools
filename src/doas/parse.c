...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    TARGS = 262,                   /* TARGS  */
    TNOPASS = 263,                 /* TNOPASS  */
    TPERSIST = 264,                /* TPERSIST  */
    TKEEPENV = 265,                /* TKEEPENV  */
    TSETENV = 266,                 /* TSETENV  */
    TSTRING = 267                  /* TSTRING  */
  };
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_TPERSIST = 9,                   /* TPERSIST  */
  YYSYMBOL_TKEEPENV = 10,                  /* TKEEPENV  */
  YYSYMBOL_TSETENV = 11,                   /* TSETENV  */
  YYSYMBOL_TSTRING = 12,                   /* TSTRING  */
  YYSYMBOL_13_n_ = 13,                     /* '\n'  */
  YYSYMBOL_14_ = 14,                       /* '{'  */
  YYSYMBOL_15_ = 15,                       /* '}'  */
  ...
  YYSYMBOL_options = 20,                   /* options  */
  YYSYMBOL_option = 21,                    /* option  */
  YYSYMBOL_strlist = 22,                   /* strlist  */
  YYSYMBOL_ident = 23,                     /* ident  */
  YYSYMBOL_target = 24,                    /* target  */
  YYSYMBOL_cmd = 25,                       /* cmd  */
  YYSYMBOL_args = 26                       /* args  */
};
...
{
       0,    81,    81,    82,    83,    84,    87,   111,   115,   121,
     124,   139,   142,   145,   148,   153,   156,   166,   170,   172,
     176,   179,   184,   186
};
#endif
...
static const char *const yytname[] =
{
  ...
  "TAS", "TCMD", "TARGS", "TNOPASS", "TPERSIST", "TKEEPENV", "TSETENV",
  "TSTRING", "'\\n'", "'{'", "'}'", "$accept", "grammar", "rule", "action",
  "options", "option", "strlist", "ident", "target", "cmd", "args", YY_NULLPTR
};
